package com.example.mutia.biodatasaya;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void openmaps(View v){
        ...
        Uri uri = Uri.parse("https://www.google.com/maps/search/pekalongan/@-6.912834, 109.667574");
    ...
    public void openemail(View v){
        ...
        i.putExtra(Intent.EXTRA_EMAIL  , new String[]{"mutiarizky147@gmail.com"});
        try {
